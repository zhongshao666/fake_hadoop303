...
public class TestProducer {
    ...
    private static void initKafka() {
        ...
        kafkaProps.put("bootstrap.servers", "192.168.18.72:9092"); //,192.168.216.139:9092,192.168.216.140:9092
        // 请求需要验证
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            producer.send(new ProducerRecord<>("test666", Integer.toString(i), "adsddsasadad你好"));
        }
